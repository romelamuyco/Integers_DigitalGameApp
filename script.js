...
function showEndGameScreen() {
    ...
    // Calculate and display total correct items
   document.getElementById('totalCorrect').innerText = `Total correctly answered items: ${correctAnswers}`;

    // Calculate and display total score
    const totalScore = (correctAnswers / totalItems) * 100;
